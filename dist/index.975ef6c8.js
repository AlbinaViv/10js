...
(0, _apiKey.fetchBreeds)().then((res)=>{
    optionMarkup(res.data);
    selectEl.removeAttribute("hidden");
}).catch((err)=>(0, _notiflixDefault.default).Notify.warning(err.messege)).finally(()=>loaderEl.classList.add("is-hidden"));
function optionMarkup(data) {
    const optionsArr = data.map(({ id , name  })=>`<option value="${id}">${name}</option>`).join("");
...
function getInfo(e) {
    ...
    catInfo.innerHTML = "";
    (0, _apiKey.fetchCatByBreed)(e.target.value).then((res)=>markupCatInfo(res.data)).catch((error)=>{
...
},{"notiflix":"fuMq1","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./api-key":"8VyGv"}],"fuMq1":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"8VyGv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
(0, _axiosDefault.default).defaults.headers.common["x-api-key"] = "live_cQnvOV2Frx6eQkmlGdFdtdHJY9bsYY2nvNXNzcWp1dc19OZF2CHgD1GLk40MK2Me";
const baseUrl = "https://api.thecatapi.com/v1/breeds";
async function fetchBreeds() {
    try {
        const res = await (0, _axiosDefault.default).get(baseUrl);
        console.log(res);
        return res;
    } catch (error) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequire1073")
